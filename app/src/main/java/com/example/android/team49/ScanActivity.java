...
import com.example.android.team49.ui.camera.CameraSourcePreview;
import com.example.android.team49.ui.camera.GraphicOverlay;
...
public final class ScanActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Handling Flash
        flashImageView = (ImageView) findViewById(R.id.flash_image_view);
        if(useFlash){
        ...
        //Handling Camera Switch
        cameraSideImageView = (ImageView) findViewById(R.id.camera_side_image_view);
        cameraSideImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                newCameraSide = mCameraSource.getCameraFacing();
                Log.d(TAG, "Camera: " +newCameraSide);
                if(newCameraSide == CameraSource.CAMERA_FACING_BACK){
                    newCameraSide = CameraSource.CAMERA_FACING_FRONT;
                } else {
    ...
    private void toggleFlash(){
        ...
        createCameraSource(true, useFlash, cameraSide);
        startCameraSource();
    ...
    private void toggleCamera(int newCameraSide){
        ...
        createCameraSource(true, false, newCameraSide);
        startCameraSource();
    ...
    @SuppressLint("InlinedApi")
    private void createCameraSource(boolean autoFocus, boolean useFlash, int newCameraSide) {
        Context context = getApplicationContext();
